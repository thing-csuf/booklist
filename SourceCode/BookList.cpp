...
std::size_t BookList::books_sl_list_size() const
{
  ...
  auto size = std::distance( _books_sl_list.begin(), _books_sl_list.end() );
  return size;
  /////////////////////// END-TO-DO (1) ////////////////////////////
}
...
BookList & BookList::operator+=( const BookList & rhs )
{
  ///////////////////////// TO-DO (3) //////////////////////////////
    ...
    /// bottom.
  for( auto it = rhs._books_vector.begin(); it != rhs._books_vector.end(); it++ )
  {
    this->insert( *it, size() );
  }
  return *this;
...
void BookList::insert( const Book & book, std::size_t offsetFromTop )       // insert new book at offsetFromTop, which places it before the current book at offsetFromTop
{
  ...
  /**********  Insert into array  ***********************/
  {
    ...
    if( _books_array_size >= _books_array.size() ) throw BookList::CapacityExceeded_Ex( "More books are inserted than will fit" exception_location );
    for( auto i = size(); i > offsetFromTop; i-- ){
  ...
  /**********  Insert into vector  **********************/
  {
    ...
    auto book_vector_offsetFromTop = std::next( _books_vector.begin(), offsetFromTop );
    _books_vector.insert( book_vector_offsetFromTop, book );
    /////////////////////// END-TO-DO (8) ////////////////////////////
  } // Insert into vector
  ...
  /**********  Insert into doubly linked list  **********/
  {
    ...
    auto book_dl_list_offsetFromTop = std::next( _books_dl_list.begin(), offsetFromTop );
    _books_dl_list.insert( book_dl_list_offsetFromTop, book );
    /////////////////////// END-TO-DO (9) ////////////////////////////
  } // Insert into doubly linked list
  ...
  /**********  Insert into singly linked list  **********/
  {
    ///////////////////////// TO-DO (10) //////////////////////////////
      ...
      /// write your own loop.
    auto book_sl_list_offsetFromTop = std::next( _books_sl_list.begin(), offsetFromTop - 1 );
    _books_sl_list.insert_after( book_sl_list_offsetFromTop, book );
    /////////////////////// END-TO-DO (10) ////////////////////////////
  } // Insert into singly linked list
...
void BookList::remove( std::size_t offsetFromTop )
{
  ...
  /**********  Remove from array  ***********************/
  {
    ...
    for( auto i = offsetFromTop; i < size() - 1; i++ )
    {
      _books_array[i] = _books_array[i + 1];
    }
    _books_array_size--;
  ...
  /**********  Remove from doubly linked list  **********/
  {
    ...
    auto book_dl_list_offsetFromTop = std::next( _books_dl_list.begin(), offsetFromTop );
    _books_dl_list.erase( book_dl_list_offsetFromTop );
    /////////////////////// END-TO-DO (13) ////////////////////////////
  } // Remove from doubly linked list
  ...
  /**********  Remove from singly linked list  **********/
  {
    ///////////////////////// TO-DO (14) //////////////////////////////
      ...
      /// write your own loop.
    auto book_sl_list_offsetFromTop = std::next( _books_sl_list.begin(), offsetFromTop - 1 );
    _books_sl_list.erase_after( book_sl_list_offsetFromTop );
    /////////////////////// END-TO-DO (14) ////////////////////////////
  } // Remove from singly linked list
...
int BookList::compare( const BookList & other ) const
{
  ...
  else
  {
    for( std::size_t i = 0; i < size();  i++)
    {
      if ( _books_vector.at( i ) < other._books_vector.at( i ) ){
