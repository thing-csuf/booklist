...
namespace    // anonymous
{
  ...
  void BookListRegressionTest::test()
  {
...

    {
      ...
      BookList list3 = { book_3, book_1, book_4, book_5 };
      affirm.is_less_than   ("Relational 1", list1, list3);
      affirm.is_greater_than("Relational 2", list3, list1);

      BookList list4 = { book_3, book_3, book_3 };
      BookList list5 = { book_3, book_3, book_3, book_3 };
      affirm.is_less_than( "Relational 3", list4, list5 );
    }
